...
function RatingSelect({ select }) {
  ...
  //useEffect - Update rating field if feedback item has been edited in feedback form
  useEffect(() => {
  ...
  return (
    <ul className="rating">
      ...
      <li>
        <input type="radio" id="num9" name="rating" value="19" onChange={handleChange} checked={selected === 9} />
